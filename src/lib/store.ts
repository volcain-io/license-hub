...
let grants: Grant[] = [
  ...
  { id: 'G2b', licenseId: 'L1', name: 'API Access', featureCode: 'api-access', status: 'active', maxActivations: 2, startsAt: '2024-08-01T00:00:00Z', expiresAt: '2025-12-31T23:59:59Z', metadata: '{"rateLimit":1000}', createdAt: '2024-08-01T10:00:00Z', updatedAt: '2024-08-01T10:00:00Z' },
  // L2 - Globex
  ...
  { id: 'G3b', licenseId: 'L2', name: 'Real-time Sync', featureCode: 'realtime-sync', status: 'active', maxActivations: 5, startsAt: '2024-05-01T00:00:00Z', expiresAt: '2025-06-30T23:59:59Z', metadata: '', createdAt: '2024-05-01T10:00:00Z', updatedAt: '2024-05-01T10:00:00Z' },
  // L3 - Wayne
  ...
  { id: 'G4b', licenseId: 'L3', name: 'MFA Module', featureCode: 'mfa', status: 'expired', maxActivations: 3, startsAt: '2024-03-01T00:00:00Z', expiresAt: '2024-12-31T23:59:59Z', metadata: '', createdAt: '2024-03-01T10:00:00Z', updatedAt: '2024-03-01T10:00:00Z' },
  // L4 - Stark
  ...
  { id: 'G5b', licenseId: 'L4', name: 'Alerting Engine', featureCode: 'alerts', status: 'active', maxActivations: 10, startsAt: '2024-07-01T00:00:00Z', expiresAt: null, metadata: '', createdAt: '2024-07-01T10:00:00Z', updatedAt: '2024-07-01T10:00:00Z' },
  { id: 'G5c', licenseId: 'L4', name: 'Custom Dashboards', featureCode: 'custom-dash', status: 'active', maxActivations: 5, startsAt: '2024-09-01T00:00:00Z', expiresAt: null, metadata: '', createdAt: '2024-09-01T10:00:00Z', updatedAt: '2024-09-01T10:00:00Z' },
  // L5 - Umbrella
  ...
  // L6 - Oscorp
  { id: 'G7', licenseId: 'L6', name: 'DevToolkit Full', featureCode: 'devtool-full', status: 'active', maxActivations: 8, startsAt: '2024-08-10T00:00:00Z', expiresAt: '2025-09-30T23:59:59Z', metadata: '', createdAt: '2024-08-10T10:00:00Z', updatedAt: '2024-08-10T10:00:00Z' },
  { id: 'G7b', licenseId: 'L6', name: 'CI/CD Integration', featureCode: 'cicd', status: 'active', maxActivations: 4, startsAt: '2024-09-01T00:00:00Z', expiresAt: '2025-09-30T23:59:59Z', metadata: '', createdAt: '2024-09-01T10:00:00Z', updatedAt: '2024-09-01T10:00:00Z' },
  // L7 - LexCorp
  { id: 'G8', licenseId: 'L7', name: 'Analytics Full Suite', featureCode: 'analytics-full', status: 'active', maxActivations: 12, startsAt: '2024-09-20T00:00:00Z', expiresAt: '2026-01-31T23:59:59Z', metadata: '', createdAt: '2024-09-20T10:00:00Z', updatedAt: '2024-09-20T10:00:00Z' },
  { id: 'G8b', licenseId: 'L7', name: 'ML Predictions', featureCode: 'ml-predict', status: 'active', maxActivations: 5, startsAt: '2024-11-01T00:00:00Z', expiresAt: '2026-01-31T23:59:59Z', metadata: '', createdAt: '2024-11-01T10:00:00Z', updatedAt: '2024-11-01T10:00:00Z' },
  // L8 - Daily Planet
  { id: 'G9', licenseId: 'L8', name: 'FormBuilder Pro', featureCode: 'forms-pro', status: 'active', maxActivations: 5, startsAt: '2024-10-05T00:00:00Z', expiresAt: '2025-11-30T23:59:59Z', metadata: '', createdAt: '2024-10-05T10:00:00Z', updatedAt: '2024-10-05T10:00:00Z' },
  // L10 - Hooli
  { id: 'G10', licenseId: 'L10', name: 'CloudMonitor Premium', featureCode: 'monitor-premium', status: 'active', maxActivations: 15, startsAt: '2024-11-01T00:00:00Z', expiresAt: '2026-03-31T23:59:59Z', metadata: '', createdAt: '2024-11-01T10:00:00Z', updatedAt: '2024-11-01T10:00:00Z' },
  { id: 'G10b', licenseId: 'L10', name: 'Log Aggregation', featureCode: 'log-agg', status: 'active', maxActivations: 10, startsAt: '2024-11-15T00:00:00Z', expiresAt: '2026-03-31T23:59:59Z', metadata: '', createdAt: '2024-11-15T10:00:00Z', updatedAt: '2024-11-15T10:00:00Z' },
];
...
let activations: Activation[] = [
  ...
  { id: 'A20', grantId: 'G1', licenseId: 'L1', deviceName: 'ACME-WS-003', deviceFingerprint: 'fp_qqq111', ipAddress: '192.168.1.12', activatedAt: '2024-04-10T08:00:00Z', lastSeenAt: '2025-03-25T11:00:00Z', isActive: true },
  // L1 / G2 - PDF export
  { id: 'A21', grantId: 'G2', licenseId: 'L1', deviceName: 'ACME-WS-001', deviceFingerprint: 'fp_abc123', ipAddress: '192.168.1.10', activatedAt: '2024-06-02T10:00:00Z', lastSeenAt: '2025-03-28T14:30:00Z', isActive: true },
  { id: 'A22', grantId: 'G2', licenseId: 'L1', deviceName: 'ACME-WS-004', deviceFingerprint: 'fp_rrr222', ipAddress: '192.168.1.13', activatedAt: '2024-06-15T09:00:00Z', lastSeenAt: '2025-02-20T10:00:00Z', isActive: false },
  // L1 / G2b - API access
  { id: 'A23', grantId: 'G2b', licenseId: 'L1', deviceName: 'ACME-API-SRV', deviceFingerprint: 'fp_sss333', ipAddress: '192.168.1.100', activatedAt: '2024-08-05T07:00:00Z', lastSeenAt: '2025-03-28T16:00:00Z', isActive: true },
  ...
  { id: 'A24', grantId: 'G3', licenseId: 'L2', deviceName: 'GLOBEX-SRV-02', deviceFingerprint: 'fp_ttt444', ipAddress: '10.0.0.6', activatedAt: '2024-04-01T10:00:00Z', lastSeenAt: '2025-03-28T15:00:00Z', isActive: true },
  { id: 'A25', grantId: 'G3', licenseId: 'L2', deviceName: 'GLOBEX-DEV-01', deviceFingerprint: 'fp_uuu555', ipAddress: '10.0.1.10', activatedAt: '2024-04-15T09:00:00Z', lastSeenAt: '2025-03-20T08:00:00Z', isActive: false },
  // L2 / G3b - Realtime sync
  { id: 'A26', grantId: 'G3b', licenseId: 'L2', deviceName: 'GLOBEX-SRV-01', deviceFingerprint: 'fp_ghi789', ipAddress: '10.0.0.5', activatedAt: '2024-05-05T10:00:00Z', lastSeenAt: '2025-03-28T16:00:00Z', isActive: true },
  // L3 / G4 - Wayne vault
  { id: 'A27', grantId: 'G4', licenseId: 'L3', deviceName: 'WAYNE-SEC-01', deviceFingerprint: 'fp_vvv666', ipAddress: '10.10.0.1', activatedAt: '2024-01-15T09:00:00Z', lastSeenAt: '2024-12-30T23:00:00Z', isActive: false },
  { id: 'A28', grantId: 'G4', licenseId: 'L3', deviceName: 'WAYNE-SEC-02', deviceFingerprint: 'fp_www777', ipAddress: '10.10.0.2', activatedAt: '2024-02-01T10:00:00Z', lastSeenAt: '2024-12-30T22:00:00Z', isActive: false },
  // L3 / G4b - Wayne MFA
  { id: 'A29', grantId: 'G4b', licenseId: 'L3', deviceName: 'WAYNE-SEC-01', deviceFingerprint: 'fp_vvv666', ipAddress: '10.10.0.1', activatedAt: '2024-03-05T08:00:00Z', lastSeenAt: '2024-12-30T23:00:00Z', isActive: false },
  ...
  { id: 'A30', grantId: 'G5', licenseId: 'L4', deviceName: 'STARK-NODE-03', deviceFingerprint: 'fp_xxx888', ipAddress: '172.16.0.3', activatedAt: '2024-08-01T09:00:00Z', lastSeenAt: '2025-03-28T12:00:00Z', isActive: true },
  { id: 'A31', grantId: 'G5', licenseId: 'L4', deviceName: 'STARK-NODE-04', deviceFingerprint: 'fp_yyy999', ipAddress: '172.16.0.4', activatedAt: '2024-09-01T10:00:00Z', lastSeenAt: '2025-03-28T11:00:00Z', isActive: true },
  // L4 / G5b - Stark alerts
  { id: 'A32', grantId: 'G5b', licenseId: 'L4', deviceName: 'STARK-NODE-01', deviceFingerprint: 'fp_jkl012', ipAddress: '172.16.0.1', activatedAt: '2024-07-10T10:00:00Z', lastSeenAt: '2025-03-28T12:00:00Z', isActive: true },
  { id: 'A33', grantId: 'G5b', licenseId: 'L4', deviceName: 'STARK-NODE-03', deviceFingerprint: 'fp_xxx888', ipAddress: '172.16.0.3', activatedAt: '2024-08-05T09:00:00Z', lastSeenAt: '2025-03-28T12:00:00Z', isActive: true },
  // L4 / G5c - Stark custom dash
  { id: 'A34', grantId: 'G5c', licenseId: 'L4', deviceName: 'STARK-DASH-01', deviceFingerprint: 'fp_aaa001', ipAddress: '172.16.1.1', activatedAt: '2024-09-05T08:00:00Z', lastSeenAt: '2025-03-28T10:00:00Z', isActive: true },
  // L6 / G7 - Oscorp devtool
  { id: 'A35', grantId: 'G7', licenseId: 'L6', deviceName: 'OSCORP-DEV-01', deviceFingerprint: 'fp_bbb002', ipAddress: '10.20.0.1', activatedAt: '2024-08-15T09:00:00Z', lastSeenAt: '2025-03-27T14:00:00Z', isActive: true },
  { id: 'A36', grantId: 'G7', licenseId: 'L6', deviceName: 'OSCORP-DEV-02', deviceFingerprint: 'fp_ccc003', ipAddress: '10.20.0.2', activatedAt: '2024-08-20T10:00:00Z', lastSeenAt: '2025-03-26T09:00:00Z', isActive: true },
  { id: 'A37', grantId: 'G7', licenseId: 'L6', deviceName: 'OSCORP-DEV-03', deviceFingerprint: 'fp_ddd004', ipAddress: '10.20.0.3', activatedAt: '2024-09-10T11:00:00Z', lastSeenAt: '2025-03-10T08:00:00Z', isActive: false },
  // L6 / G7b - Oscorp CI/CD
  { id: 'A38', grantId: 'G7b', licenseId: 'L6', deviceName: 'OSCORP-CI-01', deviceFingerprint: 'fp_eee005', ipAddress: '10.20.1.1', activatedAt: '2024-09-15T08:00:00Z', lastSeenAt: '2025-03-28T07:00:00Z', isActive: true },
  // L7 / G8 - LexCorp analytics
  { id: 'A39', grantId: 'G8', licenseId: 'L7', deviceName: 'LEX-ANALYTICS-01', deviceFingerprint: 'fp_fff006', ipAddress: '10.30.0.1', activatedAt: '2024-09-25T09:00:00Z', lastSeenAt: '2025-03-28T15:00:00Z', isActive: true },
  { id: 'A40', grantId: 'G8', licenseId: 'L7', deviceName: 'LEX-ANALYTICS-02', deviceFingerprint: 'fp_ggg007', ipAddress: '10.30.0.2', activatedAt: '2024-10-01T10:00:00Z', lastSeenAt: '2025-03-28T14:00:00Z', isActive: true },
  { id: 'A41', grantId: 'G8', licenseId: 'L7', deviceName: 'LEX-ANALYTICS-03', deviceFingerprint: 'fp_hhh008', ipAddress: '10.30.0.3', activatedAt: '2024-10-15T11:00:00Z', lastSeenAt: '2025-03-28T13:00:00Z', isActive: true },
  // L7 / G8b - LexCorp ML
  { id: 'A42', grantId: 'G8b', licenseId: 'L7', deviceName: 'LEX-ML-01', deviceFingerprint: 'fp_iii009', ipAddress: '10.30.1.1', activatedAt: '2024-11-05T08:00:00Z', lastSeenAt: '2025-03-28T12:00:00Z', isActive: true },
  // L8 / G9 - Daily Planet
  { id: 'A43', grantId: 'G9', licenseId: 'L8', deviceName: 'DP-DESK-001', deviceFingerprint: 'fp_jjj010', ipAddress: '10.40.0.1', activatedAt: '2024-10-10T09:00:00Z', lastSeenAt: '2025-03-28T11:00:00Z', isActive: true },
  { id: 'A44', grantId: 'G9', licenseId: 'L8', deviceName: 'DP-DESK-002', deviceFingerprint: 'fp_kkk011', ipAddress: '10.40.0.2', activatedAt: '2024-10-12T10:00:00Z', lastSeenAt: '2025-03-27T10:00:00Z', isActive: true },
  // L10 / G10 - Hooli
  { id: 'A45', grantId: 'G10', licenseId: 'L10', deviceName: 'HOOLI-SRV-01', deviceFingerprint: 'fp_lll012', ipAddress: '10.50.0.1', activatedAt: '2024-11-05T09:00:00Z', lastSeenAt: '2025-03-28T16:00:00Z', isActive: true },
  { id: 'A46', grantId: 'G10', licenseId: 'L10', deviceName: 'HOOLI-SRV-02', deviceFingerprint: 'fp_mmm013', ipAddress: '10.50.0.2', activatedAt: '2024-11-10T10:00:00Z', lastSeenAt: '2025-03-28T15:00:00Z', isActive: true },
  { id: 'A47', grantId: 'G10', licenseId: 'L10', deviceName: 'HOOLI-SRV-03', deviceFingerprint: 'fp_nnn014', ipAddress: '10.50.0.3', activatedAt: '2024-11-15T11:00:00Z', lastSeenAt: '2025-03-28T14:00:00Z', isActive: true },
  { id: 'A48', grantId: 'G10', licenseId: 'L10', deviceName: 'HOOLI-DEV-01', deviceFingerprint: 'fp_ooo015', ipAddress: '10.50.1.1', activatedAt: '2024-12-01T08:00:00Z', lastSeenAt: '2025-03-20T09:00:00Z', isActive: false },
  // L10 / G10b - Hooli log agg
  { id: 'A49', grantId: 'G10b', licenseId: 'L10', deviceName: 'HOOLI-LOG-01', deviceFingerprint: 'fp_ppp016', ipAddress: '10.50.2.1', activatedAt: '2024-11-20T09:00:00Z', lastSeenAt: '2025-03-28T13:00:00Z', isActive: true },
  { id: 'A50', grantId: 'G10b', licenseId: 'L10', deviceName: 'HOOLI-LOG-02', deviceFingerprint: 'fp_qqq017', ipAddress: '10.50.2.2', activatedAt: '2024-12-01T10:00:00Z', lastSeenAt: '2025-03-28T12:00:00Z', isActive: true },
];
